...
export const uiCopy = {
  en: {
    ...
    product: {
      technicalArchive: "Product family",
      requestQuote: "Request Quote",
      relatedFamily: "Related components",
  ...
  de: {
    ...
    product: {
      technicalArchive: "Produktfamilie",
      requestQuote: "Anfrage senden",
      relatedFamily: "Zugehörige Komponenten",
  ...
  fr: {
    ...
    product: {
      technicalArchive: "Famille de produits",
      requestQuote: "Demander un devis",
      relatedFamily: "Composants associés",
