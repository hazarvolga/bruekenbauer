  ...
  return (
    <PageShell className="min-h-screen px-margin-mobile pb-24 pt-32 md:ml-20 md:px-margin-desktop">
      ...
      <div className="mt-16 flex min-w-0 flex-col items-start gap-3 border-b border-graphite-muted pb-4 sm:flex-row sm:items-center sm:gap-6">
        ...
        <h2 className="min-w-0 break-words font-mono text-technical-md uppercase tracking-[0.1em] text-industrial-silver">
          {t("group_1_title")}
        </h2>
      </div>
          ...
          return (
            ...
            >
              <div className="relative z-10 flex-1">
                ...
                <p className="mt-5 break-words font-mono text-data-sm uppercase text-outline">
                  {appCopy.summary}
                </p>
              </div>
      ...
      <section className="mt-20 border border-graphite-muted bg-surface-container-low/45 p-6 md:p-8">
        ...
        <div className="mt-5 grid min-w-0 gap-6 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
          <div className="min-w-0">
            <h2 className="break-words font-mono text-headline-md-mobile uppercase text-industrial-silver md:text-headline-md">
              {t("cta_title")}
            </h2>
