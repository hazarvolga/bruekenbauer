        ...
        {applications.map((app, index) => (
          ...
          >
            <div className="relative z-10">
              ...
              <h2 className="mt-10 font-mono text-technical-md uppercase text-industrial-silver">
                {app.name}
              </h2>
              <p className="mt-5 font-mono text-data-sm uppercase text-outline">{app.summary}</p>
            </div>
            <div className="absolute bottom-0 left-0 right-0 h-28 overflow-hidden opacity-60 grayscale transition-all duration-700 ease-out group-hover:h-36 group-hover:opacity-90 group-hover:grayscale-0">
              <Image
                src={app.heroImage}
                alt=""
                fill
            ...
            <div className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-background/25 via-background/55 to-transparent transition-opacity duration-700 ease-out group-hover:opacity-70" />
